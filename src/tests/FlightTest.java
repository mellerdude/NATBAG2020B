...
class FlightTest {
	...
	public void testFilghts() {
		...
		str.append("Flight:company=elal, terminal=3, flightCode=ly001, FlightDate=20/1/2020, time: 00:45, City=newYork, Country=USA\n");
		str.append("Flight:company=elal, terminal=3, flightCode=ly315, FlightDate=20/1/2020, time: 10:10, City=london, Country=England\n");
